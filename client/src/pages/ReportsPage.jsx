...
const ReportsPage = () => {
    ...
    const fetchReportData = async () => {
        ...
        try {
            ...
            alert(`An error occurred while fetching the report data: ${error.message}`);
        }
        setLoading(false);
    };
    ...
    const handleFileChange = (event) => {
        ...
        reader.onload = (e) => {
            try {
                ...
                // Validate structure
                if (!Array.isArray(data.sales) || !Array.isArray(data.itemsSold) || typeof data.transactionTypes !== 'object') {
                ...
                alert("Invalid file format or structure. Please select a valid JSON Z report.");
            }
        };
